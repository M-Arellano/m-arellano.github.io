...
<body>
        ...
        <navigation>
            <div class="main_nav">
                <nav>
                        ...
                        <a href="#sell">Tips to Sell Fast</a>
    ...
    <div class="hero" id="home">
        <div class="hero_content">
            <div class="hero_overlay">
                ...
                <p class="brand">Success Realty<br>West Michigan</p>
            </div>
            <!--------------
    ...
    <div id="calculator">    
        <div class="mortgagecalculator">
            ...
            <div class="fullsize">
                <iframe src ="https://www.mortgagecalculator.net/embeddable/v2/?size=1&textColor=003140&backgroundColor=c5c7d6" width="100%" frameborder=0 scrolling=no height=330></iframe>
            </div>



            <div class="large">
                <iframe src ="https://www.mortgagecalculator.net/embeddable/v2/?size=2&textColor=003140&backgroundColor=c5c7d6" width="100%" frameborder=0 scrolling=no height=330></iframe>
            </div>



            <div class="medium">
                <iframe src ="https://www.mortgagecalculator.net/embeddable/v2/?size=3&textColor=003140&backgroundColor=c5c7d6" width="100%" frameborder=0 scrolling=no height=330></iframe>
            </div>


            <div class="small">
                <iframe src ="https://www.mortgagecalculator.net/embeddable/v2/?size=5&textColor=003140&backgroundColor=c5c7d6" width="100%" frameborder=0 scrolling=no height=330></iframe>
            </div>
        </div>
    </div>
    ...
    <div class="contact" id="contact">
        ...
        <h3>Realtor Success Realty</h3>
            <div>
                <p>Buying or selling a home is not only one of life’s largest transactions, but it is also a journey filled with potential pitfalls, excitement, and discovery. That’s why you need a real estate professional like me, who knows what she is doing and who can guide you to success. </p>
            </div>
